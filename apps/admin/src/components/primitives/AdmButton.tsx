...
interface AdmButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: Variant;
  size?: Size;
  fullWidth?: boolean;
...
const variantClass: Record<Variant, string> = {
  primary:
    'bg-amber text-white hover:bg-amber-hover active:bg-amber-active disabled:bg-line disabled:text-ink-mute',
  secondary:
    'bg-navy text-white hover:bg-navy-deep active:bg-navy-ink disabled:bg-line disabled:text-ink-mute',
  ghost:
    'bg-transparent text-navy border border-line hover:bg-sand active:bg-amber-tint disabled:text-ink-mute dark:text-d-text dark:border-d-line dark:hover:bg-d-raised',
...
export const AdmButton = forwardRef<HTMLButtonElement, AdmButtonProps>(function AdmButton(
